...
app.post('/generate-text', async(req, res) => {
    ...
    try {
        const prompt = `Создай случайный текст уровня "${level}" на русском языке. Объем текста не меньше 60 символов. Укажи только русский текст, без поля польского перевода. Ответ верни в формате JSON `;
