...
app.post('/generate-text', async(req, res) => {
    ...
    try {
        const prompt = `Объем текста не меньше 50 слов. Создай случайный текст уровня "${level}" на русском языке.  Укажи только русский текст, без поля польского перевода. Ответ верни в формате текста `;
