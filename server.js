...
app.post('/check-translation', async(req, res) => {
    ...
    try {
        const prompt = `Сначала пишешь перевод оригинального текста на Польский язык. Следующий текст пиши с новой строки. После ты проверяешь переводы, сравниваешь текст пользователя и правильный перевод на польский язык, после чего даешь советы по исправлению ошибок, советы и общение с пользователем на русском языке. Оригинальный текст: ${originalText}. Перевод пользователя: ${userTranslation}.`;
