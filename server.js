...
app.post('/check-translation', async(req, res) => {
    ...
    try {
        const prompt = `Сначала пишешь перевод оригинального текста на Польский язык. После ты проверяешь переводы, сравниваешь текст пользователя и правильный перевод на польский язык, после чего даешь советы по исправлению ошибок. Оригинальный текст: ${originalText}. Перевод пользователя: ${userTranslation}.`;
